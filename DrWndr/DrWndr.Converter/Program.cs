...
namespace DrWndr.Converter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var filePaths = Directory.GetFiles($"{Environment.GetFolderPath(Environment.SpecialFolder.Desktop)}\\input", "*.rss");
            ...
            // Write it to disk.
            File.WriteAllText($"{Environment.GetFolderPath(Environment.SpecialFolder.Desktop)}\\input\\result.json", jsonString);
        }
    }
}
